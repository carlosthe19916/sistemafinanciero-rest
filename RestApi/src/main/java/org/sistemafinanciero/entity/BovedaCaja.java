...
public class BovedaCaja implements java.io.Serializable {
	...
	@NotNull
	@EmbeddedId
	@AttributeOverrides({ @AttributeOverride(name = "idBoveda", column = @Column(name = "ID_BOVEDA", nullable = false, precision = 22, scale = 0)), @AttributeOverride(name = "idCaja", column = @Column(name = "ID_CAJA", nullable = false, precision = 22, scale = 0)) })
